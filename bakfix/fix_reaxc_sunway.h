...
FixStyle(REAXC/sunway,FixReaxCSunway)

#else

#ifndef LMP_FIX_REAXC_SUNWAY_H
#define LMP_FIX_REAXC_SUNWAY_H

#include "fix.h"

namespace LAMMPS_NS {

class FixReaxCSunway : public Fix {
  friend class PairReaxC;
  friend class PairReaxCOMP;
  friend class PairReaxCSunway;
 public:
  FixReaxCSunway(class LAMMPS *,int, char **);
  ~FixReaxCSunway();
  int setmask();
