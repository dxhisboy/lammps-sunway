    ...
    for (i = ist; i < ied; i ++){
      ...
      for (jj = 0; jj < jnum; jj ++){
        ...
        for (kk = 0; kk < iknum; kk ++){
          ...
          //attractive_p(params + iparam_ijk, &prefactor_ij, &r2ij, &r2ik, dij, dik, tfi, tfj, tfk);
        ...
        for (kk = 0; kk < jknum; kk ++){
          ...
          /* attractive_p(params + iparam_jik, &prefactor_ji, &r2ij, &r2jk, dji, djk, ffj, ffi, ffk); */
          /* attractive_p(params + iparam_jki, &prefactor_jk, &r2jk, &r2ij, djk, dji, rfj, rfk, rfi); */
          /* vec3_add(ffi, rfi, tfi); */
          /* vec3_add(ffj, rfj, tfj); */
          /* vec3_add(ffk, rfk, tfk); */
